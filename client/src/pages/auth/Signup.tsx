    ...
    <div className=' lg:flex lg:justify-between w-screen  h-screen '>
      ...
      >
        <form className='flex-col  '>
          ...
          <input
            type='text'
            className='bg-[#262626] mb-4 appearance-none  rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500'
          />
          <label htmlFor='' className='text-gray-200 text-md  '>
            Email
          </label>
